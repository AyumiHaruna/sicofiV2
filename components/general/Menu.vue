                ...
                <b-collapse id="nav-collapse" is-nav>
                    ...
                    <b-navbar-nav v-if="isLoged">
                        <b-nav-item-dropdown text="Reportes" right v-if="level <= 3">                    
                            ...
                            <b-dropdown-item><nuxt-link to="/proyectos/comp_cap"> Comparativo de Capítulos </nuxt-link></b-dropdown-item>
                            ...
                            <b-dropdown-item><nuxt-link to="/ingresos/comp_part"> Comparativo de Partidas </nuxt-link></b-dropdown-item>
                            <b-dropdown-item> <hr> </b-dropdown-item>
